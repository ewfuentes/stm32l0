...
void HAL_PCD_MspInit(PCD_HandleTypeDef *hpcd) {
  ...
  gpioPinMode(USB_DM, gpioMode_alternate);
  gpioPinMode(USB_DP, gpioMode_alternate);
  gpioAlternate(USB_DM, 0);
  gpioAlternate(USB_DP, 0);
  gpioOutputSpeed(USB_DM, gpioSpeed_high);
  gpioOutputSpeed(USB_DP, gpioSpeed_high);
